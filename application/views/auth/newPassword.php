...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>E-LEARNING LAB Universitas Singaperbangsa Karawang | Ubah Password</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Isi password baru</p>

    <form action="<?php echo base_url(); ?>Main/new_password_process" method="post">
